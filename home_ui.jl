...
p(style="text-align:center","Observe the effect of uncertainties within the PC-SAFT parameters for a pure-component.")]),
    ...
    a(imageview(class="center",style="display: block; margin-left: auto;margin-right: auto;",src="cdft.png",width="400px"),href="$(Router.link_to(:get_cdft))"),
    p(style="text-align:center","Predict the surface and interfacial tensions of a fluid using classical density functional theory.")]),
